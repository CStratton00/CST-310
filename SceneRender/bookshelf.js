...
window.onload = function init()
{
    ...
    //back
    colorCube([-0.5,0,0],     [0.7,1.5,0.1]);

    // shelves
    colorCube([-0.5,0.75,0.2], [0.7,0.05,0.5]);
    colorCube([-0.5,0.45,0.2], [0.7,0.05,0.5]);
    colorCube([-0.5,0.15,0.2], [0.7,0.05,0.5]);
    colorCube([-0.5,-0.15,0.2], [0.7,0.05,0.5]);
    colorCube([-0.5,-0.45,0.2], [0.7,0.05,0.5]);
    colorCube([-0.5,-0.75,0.2], [0.7,0.05,0.5]);
    ...
    //sides
    colorCube([-0.85,-0.025,0.2], [0.05,1.6,0.5]);
    colorCube([-0.15,-0.025,0.2], [0.05,1.6,0.5]);
